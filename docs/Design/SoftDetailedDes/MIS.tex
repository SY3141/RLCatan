...
\item output:  
      ...
      behind selecting $move$ (ex, feature contributions or decision breakdown).
\item exception: -
\end{itemize}
...
\begin{enumerate}
  ...
  or a proxy (ex your peers, stakeholders, potential users)? For those that
  were not, why, and where did they come from?
  \item While creating the design doc, what parts of your other documents (ex
