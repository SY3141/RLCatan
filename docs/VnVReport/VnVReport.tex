...
\subsection{Answers}
    \begin{enumerate}
        ...
        As I’ll mention in a later answer, we did have to make some minor modifications to some planned tests, but mostly they were executed very closely to how they were originally written.
