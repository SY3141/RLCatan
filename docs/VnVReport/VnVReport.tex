...
On going from rev1 to the final demo we will be
creating a huge UI overhaul to address the usability issues identified in our testing. This will include a more intuitive layout,
...
We will also be incorporating a LLM-based feedback system to provide the players insight into why certain moves are made since our usability testing discovered some confusion in users.
We will also need to refactor some of the codebase based on the maintainability tests we ran to improve readability and modularity. This will involve restructuring certain modules, adding more detailed comments,
and ensuring consistent coding standards across the project.
...
For this reflection, we decided all of the questions were better answered as one cohesive reflection rather than answering each question individually.
    \begin{enumerate}
        \item I would say overall this deliverable went quite smoothly.
        It certainly felt like less of a time crunch than previous docs such as the SRS.
        I think this is mostly because we did a good job with the original VnV plan, so carrying out the plan didn’t have many major hurdles.
        As we’ll mention in a later answer, we did have to make some minor modifications to some planned tests, but mostly they were executed very closely to how they were originally written.
        \item
