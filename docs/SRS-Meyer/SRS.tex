...
The agent will be tested in different \emph{\Catan{}} environments (e.g., Python implementations, or standardized Open\AI{} Gym-style interfaces) to ensure stable and consistent behavior across frameworks.
