...
\begin{itemize}
    ...
    \item Industry standards – PEP 8[9] and Google style guides[7] define coding standards.
\end{itemize}
...
\begin{table}[h!]
    ...
    \hline
    NFR.E.6 & All JavaScript/React code shall pass Google Style Guide[7] checks with 0 critical violations before deployment. & x \\
    \hline
