...
\section*{Changes from Orginal SRS meyer layout}

\begin{table}[hp]
\begin{tabularx}{\textwidth}{lX} % only 2 columns
    \toprule
...
\raggedright Moved glossary to beginning of document (see Changes from Oringal Srs Meyer Layout Section).
