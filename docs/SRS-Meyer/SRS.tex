...
\begin{itemize}
    ...
    \item {Open\AI{} Gym} – Provides a training/testing environment for reinforcement learning agents.
...
\begin{itemize}
  \item R21 Maintain a synchronized digital model of the physical \Catan{} \GameState{}.
...
\begin{itemize}
  \item R41 Provide an interactive visual layout of the \Catan{} board and \GameState{}.
...
\begin{itemize}
  \item R51 Store complete and consistent records of all ongoing and past \Catan{} games.
...
\parbox[t]{4cm}{Core to the \Catan{} game structure and board logic.} &
2025-11-06 \\
\hline
...
The agent will be tested in different \Catan{} environments (e.g., Python implementations, or standardized Open\AI{} Gym-style interfaces) to ensure stable and consistent behavior across frameworks.
...
\begin{itemize}
    ...
    \item {\AI{} framework} – Reinforcement learning agent trained using the Open\AI{} Gym \emph{\Catan{}} simulator.
...
\begin{enumerate}
    ...
    top currently existing competitive \Catan{} bots. We were able to look at the limitations
    ...
    learning, computer vision, as well as competitive \Catan{} strategies. We will also need
    ...
    foundation in this area. For competitive \Catan{} strategies, we will leverage the expertise of
    competitive players as well as our own experience playing the game. We will also study existing \Catan{} bots
