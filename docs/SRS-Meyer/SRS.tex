...
\begin{itemize}
    ...
    \item {Visualization Interface} – Displays the current game state and AI recommendations to users.
...
\begin{itemize}
    ...
    \item {Computer vision} – Implemented using OpenCV and/or YOLOv9 for board state detection and tracking.
