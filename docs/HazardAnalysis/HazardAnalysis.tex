...
\begin{itemize}
    \item FR.Sa.1: The system shall enable users to manually confirm the parsed board state before generating advice. \label{FR.Sa.1}
    \item FR.Sa.2: The system shall provide a resynchronization mechanism (manual correction or re-scan). \label{FR.Sa.2}
    \item FR.Sa.3: The system shall validate all AI-suggested moves against the official rules of Catan before display. \label{FR.Sa.3}
    \item FR.Sa.4: The system shall provide a clear error message if advice cannot be generated. \label{FR.Sa.4}
    \item FR.Sa.5: The system shall ensure current game state is saved correctly before recommending move(s) to the user. \label{FR.Sa.5}
    \item FR.Sa.6: The system shall attempt automatic reconnection at least 3 times before failing. \label{FR.Sa.6}
    \item FR.Sa.7: The system shall visually distinguish the move(s) suggested by AI. \label{FR.Sa.7}
    \item FR.Sa.8: The system shall notify the user in the event board streaming ceases. \label{FR.Sa.8}
    \item FR.Sa.9: The system shall warn the user when incomplete game data is read where possible. \label{FR.Sa.9}
    \item FR.Sa.10: The system shall enable the user to roll back to previous model versions. \label{FR.Sa.10}
    \item FR.Sa.11: The system shall only capture and process game board area, not player faces or personal content. \label{FR.Sa.11}
    \item FR.Sa.12: Iterations of the reinforcement learning environment shall be automatically validated to ensure its simulation dynamics remain consistent with real gameplay conditions. \label{FR.Sa.12} \newline
\end{itemize}

\subsection{Non-Functional Safety Requirements}
\begin{itemize}
    \item NFR.Sa.1: The system shall ensure advice is displayed within 5 seconds of request. \label{NFR.Sa.1}
    \item NFR.Sa.2: The system shall notify the user of connection loss within 5 seconds. \label{NFR.Sa.2}
\end{itemize}
