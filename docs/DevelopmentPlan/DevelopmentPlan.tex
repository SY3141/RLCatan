...
being able toeffectively learn to play Catan at a high level, 
...
improving or at least not regressing. To mitigate these risks, 
we will conduct regular elo testing against existing benchmark 
opponents to make sure the AI is improving or at least not 
regressing. We will also conduct user testing sessions to 
gather feedback and make iterative improvements to the interface. 
...
We also want to get a A/A+ in the course, since we are putting alot of effort into the
project.
...
knows 24 hours in advance if a member is going to miss a meeting or deadline. This time
...
task each week. It is expected that all tasks we complete are of high quality
...
there is a disagrement , the team leader will have the final say.
